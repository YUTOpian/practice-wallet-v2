...
// ============================================================
// HTMLエスケープ
// ブロックチェーン上のメッセージ、他人が作成した証明書(apostille)の
// fileName/owner等、CSVインポート内容など「外部から渡ってくる可能性が
// あるテキスト」をinnerHTML/属性値に埋め込む前には必ずこれを通すこと。
// (誰でも自由な文字列をトランザクションメッセージ等に埋め込めるため、
//  エスケープを怠るとストアド型XSSに直結する)
// ============================================================
